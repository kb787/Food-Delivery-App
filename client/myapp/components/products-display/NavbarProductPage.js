  ...
  const handleFilterButtonClick = async () => {
    ...
    try {
      ...
      if (buttonClicked === true) {
        apiUrl = `http://192.168.209.116:3500/v1/api/product/search-product?productName=${productName}&productType=${productType}&productRate=${productRate}`;
      } else {
        apiUrl = 'http://192.168.209.116:3500/v1/api/product/show-product';
      }
